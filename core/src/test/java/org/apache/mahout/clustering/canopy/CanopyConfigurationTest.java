...
public class CanopyConfigurationTest {
  ...
  public void testConstructor() {
    ...
    assertEquals(outputBase, canopyConfiguration.getOutputBasePath());
    ...
    assertEquals("outputBase", canopyConfiguration.getOutputBasePath().toString());
    assertEquals("outputBase/clusters-0", canopyConfiguration.getCanopyPath().toString());
