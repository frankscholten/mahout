...
public class CanopyDriver extends AbstractJob {
  ...
  public static void run(Path input,
    ...
    run(new Configuration(), input, output, measure, t1, t2, t3, t4, runClustering, runSequential);
  }
   ...
   * @param t1            the double T1 distance metric
   * @param t2            the double T2 distance metric
   * @param t3            the double T3 distance metric
   * @param t4            the double T4 distance metric
   * @param runClustering cluster the input vectors if true
   * @param runSequential execute sequentially if true
   */
  public static void run(Configuration conf,
    ...
    log.info("Build Clusters Input: {} Out: {} " + "Measure: {} t1: {} t2: {} t3: {} t4: {}",
    ...
    canopyConfiguration.setT3(t3);
    canopyConfiguration.setT4(t4);
  ...
  public static void run(Configuration conf, Path input, Path output, DistanceMeasure measure, double t1, double t2, boolean runClustering, boolean runSequential) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, InterruptedException {
